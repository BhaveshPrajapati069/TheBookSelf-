...
function Navbar() {
  ...
  const elemenent = document.documentElement;
  useEffect(() => {
    if (theme === "dark") {
      elemenent.classList.add("dark");
      localStorage.setItem("theme", "dark");
      document.body.classList.add("dark");
    } else {
      elemenent.classList.remove("dark");
      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className=" text-xl font-bold cursor-pointer">TheBookshelf</a>
          </div>
